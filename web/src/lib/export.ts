...
export function exportCSV(findings: Finding[], repoName: string) {
  const header = [
    "Severity",
    "Tool",
    "Rule",
...
export function exportJSON(findings: Finding[], repoName: string) {
  download(
...
export function exportPDF(findings: Finding[], repoName: string) {
...
export function exportFindings(
  ...
  if (format === "csv") exportCSV(findings, repoName);
  else if (format === "json") exportJSON(findings, repoName);
  else exportPDF(findings, repoName);
}